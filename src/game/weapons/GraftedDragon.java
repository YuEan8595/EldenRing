...
/**
 * A class that represents a weapon named Grafted Dragon.
 * Created by:
 * @author Lai Khairong
 */
public class GraftedDragon extends WeaponItem implements Sellable {
    ...
    /**
     * A constructor for GraftedDragon class to initialize its name, displayChar, damage, and verb
     */
    public GraftedDragon() {
        super("Grafted Dragon", 'N', 89, "hits", 90);
        sellWeaponAction = new SellWeaponAction(this, getSellCost());
    }
     ...
     */
    @Override
    public int getSellCost() { return 200; }
}
